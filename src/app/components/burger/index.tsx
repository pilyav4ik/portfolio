...
export default function ({ openMenu }: any) {
    ...
    return (
        <>
            <button onClick={() => { openMenu() }} type="button" className="max-md:px-3 uppercase text-white bg-black  hover:text-slate-900 hover:bg-white focus:outline-none font-medium rounded-full text-md px-5 py-2.5 mr-3 text-center">
