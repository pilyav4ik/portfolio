...
export default function Email({ closeMenu }: any) {
    ...
    return (
        <>
            <p className="flex items-center -mx-2 py-4 hover:cursor-pointer" onClick={() => copyToClipboard('info.sviplab@gmail.com')}>
                ...
                info.sviplab@gmail.com
                </span>
            </p>
            {isCopied && <span className="bg-white ml-1 text-sm rounded px-2 py-2 mb-5 text-black absolute bottom-[1vh]">Copied!</span>}
